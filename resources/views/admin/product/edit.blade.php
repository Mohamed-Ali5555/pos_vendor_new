                                ...
                                <div class="row clearfix">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input id="thumbnail1" class="form-control" type="text"
                                                    name="size_guide" value="{{ $product->size_guide }}">
                                            </div>
                                    ...
                                    <div class="col-lg-12 col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="number" min="0" max="100" step="any"
                                                class="form-control" placeholder="Discount" name="discount"
                                    ...
                                    <div class="col-lg-12  col-sm-12">
                                        ...
                                        <select name="size" class="form-control show-tick">
                                            ...
                                            <option value="XL" {{ $product->size == 'XL' ? 'selected' : '' }}>Extra
                                                Larg
                                            </option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-lg-12  col-sm-12">
                                        ...
                                        <select name="condition" class="form-control show-tick">
                                            ...
                                            <option value="popular"
                                                {{ $product->condition == 'popular' ? 'selected' : '' }}>Popular
                                            </option>
                                            <option value="winter"
                                                {{ $product->condition == 'winter' ? 'selected' : '' }}>Winter
                                            </option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-lg-12 col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea id="description" class="form-control description" placeholder="write some text....."
