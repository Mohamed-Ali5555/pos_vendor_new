                            ...
                            <div class="row">
                                <div class="col-12 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="firstName" name="full_name"
                                            placeholder="MD NAZRUL" value="{{ $user->full_name }}">
                                        @error('full_name')
                                ...
                                <div class="col-12 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="lastName" name="username"
                                            placeholder="ISLAM" value="{{ $user->username }}">
                                        @error('username')
                                            <p class="text-danger">{{ $message }}</p>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="displayName" name="phone"
                                            placeholder="09876543" value="{{ $user->phone }}">
                                        @error('phone')
                                            <p class="text-danger">{{ $message }}</p>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control" id="emailAddress" name="email"
                                            placeholder="care@gmail.com" value="{{ $user->email }}" disabled>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
